...
function Services() {
  return (
    <section className="serviceContent mt-48   max-w-[1200px] mx-auto my-10">
      <h1 className="text-center mb-6 text-[48px] font-sans font-bold">Стоматология<br/><span className="font-sans font-bold text-[70px] text-[rgb(0,130,255)] drop-shadow-[0_2px_3px_rgba(50,130,255)]">Селена</span></h1>
      <h2 className="sectionMainTitle text-center mb-6 font-sans font-bold text-[30px]">Только лучшее лечение зубов</h2>
      <div className="serviceBoxes flex items-center justify-center flex-wrap gap-5">
        {/* Teeth Whitening */}
        <div className="serviceBox shadow-lg shadow-[rgb(0,130,255)] hover:bg-blue-200">
        ...
        {/* Oral Surgery */}
        <div className="serviceBox lg:mt-5 shadow-lg shadow-[rgb(0,130,255)] hover:bg-blue-200">
          <div className="serviceBoxImgContent">
