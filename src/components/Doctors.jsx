    ...
    return(
        <div className="mx-auto mb-10 min-h-[800px] flex-col flex justify-center items-center max-w-[1000px] p-4 border-[2px] border-gray-300 border-b-[5px] shadow-xl shadow-[rgb(0,130,255)] rounded-[30px]">
            ...
            <div className="mt-10 flex justify-center">
                <img src={doctor_1} alt="doc_1" className="rounded-[30px] border-[2px] border-white size-1/3 shadow-xl drop-shadow-[0_4px_8px_rgba(0,130,255)] transition delay-150 duration-500 hover:scale-105"/>
            </div>
