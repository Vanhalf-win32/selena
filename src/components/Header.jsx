...
function Header() {
  return (
    <header className="headerContent flex justify-between items-center max-w-[1200px] 
      ...
      <div className="heroTitle text-[52px]
        ...
        <span className="leading-5">
          <h3 className="ml-10 text-gray-700 text-[20px]">стоматология</h3>
      ...
      <div className="headerMenuListItem font-medium headerMenuContent lg:mt-2 flex-col flex items-center lg:text-[14px] text-[10px] lg:w-[150px] w-[100px]">
        ...
        <a className="lg:w-full w-[70px] flex justify-center items-center text-center">Версия<br/>для слабовидящих</a>
      </div>      
      <div className="headerContactContent">
        <button className="headerContactButton 
          ...
          gap-2 border-solid bg-blue-500 border-[2px] rounded-[25px]">
          Записаться
        </button>
      </div>
    </header>
