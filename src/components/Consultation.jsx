    ...
    <section className="consultationContent mt-56 grid grid-cols-[0.4fr_0.6fr] place-items-center max-w-[1040px] mx-auto my-10 gap-5 rounded-[50px] max-lg:flex max-lg:flex-col max-lg:w-fit max-lg:p-5">
      ...
      <div className="consultationFormSide max-lg:p-5 max-md:p-0">
        ...
        <form action="POST" className="consultationForm">
          ...
          "
          >
            <input type="text" placeholder="Полное имя" className="consultationInput drop-shadow-[0_8px_10px_rgba(0,130,255)] max-md:w-full" />
            <input type="text" placeholder="Вид услуги" className="consultationInput drop-shadow-[0_8px_10px_rgba(0,130,255)]  max-md:w-full" />
            <input type="email" placeholder="Email" className="consultationInput drop-shadow-[0_8px_10px_rgba(0,130,255)]  max-md:w-full" />
            <input type="tel" placeholder="Номер телефона " className="consultationInput drop-shadow-[0_8px_10px_rgba(0,130,255)] max-md:w-full" />
          </div>
