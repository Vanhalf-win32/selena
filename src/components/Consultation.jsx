    ...
    <section className="consultationContent mt-56 grid grid-cols-[0.4fr_0.6fr] place-items-center max-w-[1140px] mx-auto my-10 gap-5 rounded-[50px] max-lg:flex max-lg:flex-col max-lg:w-fit max-lg:p-5">
      ...
      <div className="consultationFormSide max-lg:p-5 max-md:p-0">
        ...
        <form action="POST" className="consultationForm">
          ...
          "
          >
            <input type="text" placeholder="Полное имя" className="consultationInput max-md:w-full" />
            <input type="text" placeholder="Вид услуги" className="consultationInput max-md:w-full" />
            <input type="email" placeholder="Email" className="consultationInput max-md:w-full" />
            <input type="tel" placeholder="Номер телефона " className="consultationInput max-md:w-full" />
          </div>
